...
import  background  from "../asset/bgOne.jpg"

export const Intro = () => {
  return (
    <div style={{ backgroundImage: `url(${background})` }} className="h-screen bg-cover bg-no-repeat bg-center flex flex-col justify-center items-left">
        <blockquote className="text-6xl italic font-semibold text-white dark:text-white ">
